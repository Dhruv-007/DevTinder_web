      ...
      <div className="card-body items-center text-center">
       ...
       <p>{age}</p>
        <div className="card-actions flex justify-center gap-6 mt-4">
          ...
          <button className="bg-white rounded-full p-3 shadow hover:bg-gray-200 transition-colors">
          ...
          <button className="bg-white rounded-full p-3 shadow hover:bg-red-100 transition-colors">
